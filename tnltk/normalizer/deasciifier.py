...
class Deasciifier:
      ...
      def __init__(self, ascii_string):
            """
            This function initializes the Deasciifier class.
            It takes an ascii_string as input and creates an instance of the Deasciifier class.
      ...
      def set_char_at(self, str, position, char):
            ...
            Example
            --------
            >>> deasciifier = Deasciifier("hello world")
      ...
      def turkish_need_correction(self, char, point = 0):
            ...
            Examples
            --------
            >>> deasciifier = Deasciifier("Opusmegi cagristiran catirtilar.")
      ...
      def turkish_match_pattern(self, dlist, point = 0):
            ...
            """
            rank = 2 * len(dlist)
            str = self.turkish_get_context(Deasciifier.context_size,
                                           point = point)
            start = 0
            end = 0
      ...
      def turkish_get_context(self, size = context_size, point = 0):
            ...
            >>> context_size = 5
            >>> point = 7
            >>> string.get_context(context_size, point)
            'is a sa'
            """
            s = ' ' * (1 + (2 * size))
            ...
            while i < len(s) and not space and index < len(self.ascii_string):
                  current_char = self.converted_string[index]
                  x = self.turkish_downcase_asciify_table.get(current_char
                                                                     ,False)
                  if not x:
                        if not space:
                              i = i + 1
            ...
            while i >= 0 and index >= 0:
                  current_char = self.converted_string[index]
                  x = self.turkish_upcase_accents_table.get(current_char
                                                                   ,False)
                  if not x:
                        if not space:
                              i = i - 1
